...
var server_window_width = 300;
var server_window_height = 120;
...
function OnGUI ()
{
	if(Network.peerType == NetworkPeerType.Disconnected){
		...
		if (GUI.Button(Rect(Screen.width/2-40,Screen.height-20,80,20), "Disconnect"))
		{
			Network.Disconnect();
...
function Awake ()
{
	...
	windowRect = Rect(
					Screen.width/2-server_window_width/2,
					Screen.height/2-server_window_height/2,
					server_window_width,
					server_window_height);
...
private var server_name = "Server name";
private var server_description = "description\n";
...
//	}
	...
	if (Network.peerType == NetworkPeerType.Disconnected)
	{
		...
		if (GUILayout.Button("Start Server"))
		{
			...
			MasterServer.RegisterHost(gameName, server_name, server_description);
		}
		...
		server_name = GUILayout.TextField(server_name,25);
		server_description = GUILayout.TextArea(server_description);
